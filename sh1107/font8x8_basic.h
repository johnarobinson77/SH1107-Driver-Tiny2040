...
/* NOTE: THIS VERSION OF THE FONT IS TRANSPOSED FROM THE FILE DOWNLOED FORM github
 * In the original file, the fist byte represents the top row of pixels and the last byte the 
 * bottom row
 * In this file, the first byte represent the left column of pixels and the last byte the right.
 * 
 * Modificaton made by John Robinson April 2021.
 */
